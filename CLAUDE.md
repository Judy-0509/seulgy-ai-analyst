...
| Humanoid | 14 | 27 | 빨강 (`#b73745`) |
| Automotive | 26 | 168 | 파랑 (`#2563eb`) |
| Space Datacenter | 8 | 52 | 청록 (`#22d3a6`) |

> Humanoid는 14개 전용 빌더 외에 스마트폰 트래커 3개(Counterpoint·TrendForce·IDC) + 추가 시장조사 4개(IDTechEx·ABI·Yano·IFR) + Humanoids Daily / RoboticsTomorrow 등이 합쳐져 실제로는 23개 소스를 사용 (전부 active).
