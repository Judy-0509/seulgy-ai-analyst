...
산출:
    data/archives/alixpartners.json
"""
import asyncio
import io
import json
...
ARCHIVE_PATH = ARCHIVE_DIR / "alixpartners.json"
SOURCE_NAME  = "AlixPartners"
SITE_BASE    = "https://www.alixpartners.com"
SITEMAP_URL  = "https://www.alixpartners.com/sitemap.xml"
URL_INCLUDES: list[str] = ["/insights/", "/perspectives/", "/news/", "/media/"]
URL_EXCLUDES: list[str] = ["/careers/", "/our-people/", "/offices/", "/tag/"]
MAX_ARTICLES = 300
CONCURRENCY  = 5
REQUEST_TIMEOUT = 20
# ──────────────────────────────────────────────────────────────────
