...
ARCHIVE_PATH = ARCHIVE_DIR / "vw_group.json"
SOURCE_NAME  = "VW Group"
SITE_BASE    = "https://www.volkswagenag.com"
SITEMAP_URL  = "https://www.volkswagenag.com/sitemap.xml"
URL_INCLUDES: list[str] = ["/en/news/", "/en/press-releases/", "/en/stories/", "/en/group/"]
URL_EXCLUDES: list[str] = ["/de/", "/fr/", "/zh/", "/careers/", "/investors/"]
MAX_ARTICLES = 400
CONCURRENCY  = 5
REQUEST_TIMEOUT = 20
# ──────────────────────────────────────────────────────────────────
