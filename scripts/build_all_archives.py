...
BUILDERS = [
    ...
    ("IDTechEx",                   "build_idtechex_humanoid_archive.py",    "idtechex_humanoid.json"),
    ("ABI Research",               "build_abi_humanoid_archive.py",         "abi_humanoid.json"),
    ("Yano Research",              "build_yano_humanoid_archive.py",        "yano_humanoid.json"),
    ...
    ("Goldman Sachs Research",     "build_goldman_sachs_archive.py",         "goldman_sachs.json"),
