...
ARCHIVE_PATH = ARCHIVE_DIR / "jato.json"
SOURCE_NAME  = "JATO Dynamics"
SITE_BASE    = "https://www.jato.com"
SITEMAP_URL  = "https://www.jato.com/sitemap.xml"
URL_INCLUDES: list[str] = ["/resources/news-and-insights/", "/resources/media-and-press-releases/", "/resources/reports-and-whitepapers/", "/resources/product-announcements/"]
URL_EXCLUDES: list[str] = ["/careers/", "/about/", "/contact/", "/events/", "/tag/", "/author/", "/our-experts/", "/our-regions/"]
MAX_ARTICLES = 300
CONCURRENCY  = 5
REQUEST_TIMEOUT = 20
# ──────────────────────────────────────────────────────────────────
