...
ARCHIVE_PATH = ARCHIVE_DIR / "wardsauto.json"
SOURCE_NAME  = "WardsAuto"
SITE_BASE    = "https://www.wardsauto.com"
SITEMAP_URL  = "https://www.wardsauto.com/sitemap.xml"
URL_INCLUDES: list[str] = ["/industry/", "/vehicles/", "/technology/", "/news/", "/data/"]
URL_EXCLUDES: list[str] = ["/author/", "/tag/", "/topic/", "/webcasts/", "/whitepapers/"]
MAX_ARTICLES = 400
CONCURRENCY  = 5
REQUEST_TIMEOUT = 20
# ──────────────────────────────────────────────────────────────────
